...
export default function MLBOrderLookup() {
  ...
  const handleLookup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        'https://anwfwwafmjzvklndzqmw.supabase.co/functions/v1/get-order-details',
        {
          method: 'POST',
          headers: {
            'X-API-Key': apiKey,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">MLB Order Lookup</h1>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">
                        {new Date(orderData.payment.transaction.processed_at).toLocaleString()}
                      </p>
                    </div>
