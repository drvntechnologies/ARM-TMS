...
export default function NewQuote() {
  ...
  const updateOrigin = (field: keyof LocationState, value: string) =>
    setOrigin(prev => ({ ...prev, [field]: value }));

  const updateDestination = (field: keyof LocationState, value: string) =>
    setDestination(prev => ({ ...prev, [field]: value }));

  const handleOriginAddressSelect = (components: AddressComponents) => {
    setOrigin(prev => ({
      ...prev,
  ...
  const handleDestinationAddressSelect = (components: AddressComponents) => {
    setDestination(prev => ({
      ...prev,
      address: components.street || prev.address,
      city: components.city || prev.city,
  ...
  const LocationBlock = ({
    ...
    title: string;
    loc: LocationState;
    onField: (f: keyof LocationState, v: string) => void;
